...
public class ReapersScytheSweepParticles extends BillboardParticle {

    private final SpriteProvider spriteProvider;

    protected ReapersScytheSweepParticles(ClientWorld world, double x, double y, double z, double scale, SpriteProvider spriteProvider) {
