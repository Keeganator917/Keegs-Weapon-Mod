...
public class ReapersScytheSweepParticles extends SingleQuadParticle {

    private final SpriteSet spriteProvider;

    protected ReapersScytheSweepParticles(ClientLevel world, double x, double y, double z, double scale, SpriteSet spriteProvider) {
