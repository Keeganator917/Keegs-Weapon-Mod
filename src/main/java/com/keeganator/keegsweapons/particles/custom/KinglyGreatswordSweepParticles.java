...
public class KinglyGreatswordSweepParticles extends BillboardParticle {

    private final SpriteProvider spriteProvider;

    protected KinglyGreatswordSweepParticles(ClientWorld world, double x, double y, double z, double scale, SpriteProvider spriteProvider) {
        super(world, x, y, z, spriteProvider.getSprite(0, 12));
