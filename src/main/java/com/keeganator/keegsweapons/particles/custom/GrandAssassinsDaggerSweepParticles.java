...
public class GrandAssassinsDaggerSweepParticles extends BillboardParticle {

    private final SpriteProvider spriteProvider;

    protected GrandAssassinsDaggerSweepParticles(ClientWorld world, double x, double y, double z, double scale, SpriteProvider spriteProvider) {
