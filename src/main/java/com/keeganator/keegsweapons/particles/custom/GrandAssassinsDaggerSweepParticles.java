...
public class GrandAssassinsDaggerSweepParticles extends SingleQuadParticle {

    private final SpriteSet spriteProvider;

    protected GrandAssassinsDaggerSweepParticles(ClientLevel world, double x, double y, double z, double scale, SpriteSet spriteProvider) {
        super(world, x, y, z, spriteProvider.get(0, 8));
