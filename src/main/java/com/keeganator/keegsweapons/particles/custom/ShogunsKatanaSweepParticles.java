...
public class ShogunsKatanaSweepParticles extends SingleQuadParticle {

    private final SpriteSet spriteProvider;

    protected ShogunsKatanaSweepParticles(ClientLevel world, double x, double y, double z, double scale, SpriteSet spriteProvider) {
