...
public class ModGamerules {
    ...
    public static final GameRule<Boolean> DO_WEAPON_FORGE_STRUCTURES_SPAWN =
            GameRuleBuilder.forBoolean(true).buildAndRegister(Identifier.of("keegsweapons", "do_weapon_forge_structures_spawn"));

    public static final GameRule<Boolean> DO_WEAPON_FORGE_RECIPE_BLOCKING =
            GameRuleBuilder.forBoolean(true).buildAndRegister(Identifier.of("keegsweapons", "do_weapon_forge_recipe_blocking"));
